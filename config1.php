<?php
// config1.php - Database connection and owner resolution logic
// Database connection parameters for localhost using PhpMyAdmin - XAMPP 
// Rename as config.php everytime using
